#!/usr/bin/env python3
"""HTE Tracking Bot — Railway deployment"""
...
CSS = """.logo-img{width:44px;height:44px;object-fit:contain}*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
...
<header>
  <a class="logo" href="https://sdlg.online" target="_blank">
    <img class=\"logo-img\" src=\"{LOGO_SRC}\" alt=\"HTE\">
